...
extern "C" long syscallHandler(uint32_t* context, long num, long a0, long a1) {
    ...
    case 8 : /* open */
        {
            ...
            if (f == nullptr) return ERR_FILE_NOT_FOUND;
    ...
    case 503: /* win_clear() */
        {
          WindowManager::wm->currentWindow()->clear();
          return 1;
        }
    case 504: /* win_height() */
        {
          return WindowManager::wm->currentWindow()->height;
        }
    case 505: /* win_width() */
        {
          return WindowManager::wm->currentWindow()->width;
        }
    default:
